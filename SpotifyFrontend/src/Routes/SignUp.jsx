    ...
    return(
        <div className="w-full h-full flex flex-col items-center  bg-[url('./assets/spotifybg.webp')] bg-cover bg-center bg-no-repeat">
            ...
            <button type='button' className='font-medium text-black bg-green-400   pr-5 pl-5 pt-1 pb- rounded-4xl shadow-lg shadow-green-400 hover:bg-white hover:text-green-400'>
                <Link to='/login'>Login Spotify</Link>
            </button>  
            </div>

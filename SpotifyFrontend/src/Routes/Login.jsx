    ...
    return (
        <div className="w-screen h-screen md:flex bg-black">
            ...
            <div className="sm: w-3/3 md:w-2/3 h-full relative overflow-hidden">
                ...
                <button
                    onClick={toggleMute}
                    className="absolute bottom-6 right-6 bg-white bg-opacity-50 text-black px-4 py-2 rounded-full hover:bg-opacity-80 transition"
                >
                    {isMuted ? 'Unmute' : 'Mute'}
                </button>
            </div>

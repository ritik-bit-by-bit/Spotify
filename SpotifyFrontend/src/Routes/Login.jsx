        ...
        <div className="w-80 p-8 shadow-2xl shadow-gray-800 rounded-2xl bg-black bg-opacity-60">
          ...
          <div className="space-y-4">
            <Label
              type="email"
              title="Email address"
              inputmessage="Enter email address "
              textcolor="white"
              value={email}
              setValue={setEmail}
            />
            <Label
              type="password"
              title="Password"
              inputmessage="Enter Your Password"
              textcolor="white"
              value={password}
          ...
          <div className="mt-6 flex justify-center">
            <button
              type="button"
              className="font-medium text-black bg-green-400 px-6 py-2 rounded-full shadow-lg hover:bg-white hover:text-green-400 transition"
             onClick={(e)=>{
                e.preventDefault();
                SubmitForm();
             }}

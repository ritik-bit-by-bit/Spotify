...
const LoginComponent = ()=>{
    return(
        <div className="w-full h-full flex flex-col items-center">
            ...
            <hr className="h-px mr-10 ml-2 my-4 w-80 bg-gray-200 border-0 dark:bg-gray-700"></hr>
            <div className='font-medium text-md text-center'>
                Don't have an account?
            </div>
            <hr className="h-px mr-10 ml-2 my-4 w-80 bg-gray-200 border-0 dark:bg-gray-700"></hr>
            <div className='justify-self-center pb-4'>
            <button type='button' className='font-medium text-black bg-white  border-1 pr-5 pl-5 pt-1 pb- rounded-4xl shadow-lg shadow-gray-400 hover:bg-green-400 hover:text-white'>
                    Sign Up for Spotify
            </button>  
            </div>

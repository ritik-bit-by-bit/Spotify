...
const LoginComponent = ()=>{
    return(
        <div className="w-full h-full flex flex-col items-center">
            ...
            <button type='button' className='font-medium text-black bg-green-400 pr-5 pl-5 pt-1 pb-1 rounded-4xl mr-15'>
                    Login
            </button>  
            </div>
            ...
            <button type='button' className='font-medium text-black bg-white  border-1 pr-5 pl-5 pt-1 pb-1 rounded-4xl mr-15'>
                    Sign Up for Spotify
            </button>  
            </div>
